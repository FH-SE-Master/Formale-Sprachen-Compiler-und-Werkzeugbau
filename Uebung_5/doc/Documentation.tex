...
\end{figure}
\ \newline
Der LL1-Konflikt wird durch das \emph{dangling else} verursacht, was aber kein Problem darstellt.

\begin{figure}[h]
	\centering
	\includegraphics[scale=0.65]{\imageDir/minicpp-test-console.JPG}
	\caption{Konsolenausgabe des \emph{Parser}}
	\label{fig:minicpp-test}
\end{figure}
