...
public class MiniCSyn {
  ...
  private const int LASTTERM   =   47;
  private const int LASTPRAGMA =   47;
  ...
  private class GrammarTable {
    ...
    public byte[] code = {
         0,   2,   0,   3,   0,  40,   0,  41,   0,  44,   5,   1,  16,   0,
         1,   4,   2,   2,   0,  45,  11,   0,   7,   2,  46,   1,   1,  20,
        37,   0,   2,  46,   2,  10,  27,   0,   0,  19,  11,   4,   3,   1,
         5,   3,  51,   0,   2,  10,  43,   0,   8,   1,  11,   3,  46,  67,
         0,   1,   0,  21,   4,   4,   2,   0,  19,  11,   1,  17,  81,   0,
         0,  40,   2,  46,   3,   0,  41,  10,  64,   0,   1,  18,  64,   0,
         0,  40,   4,   4,   4,   0,  41,  10,  64,   0,   4,   5,   1,   1,
        22, 108,   0,   4,   5,   2,  10,  98,   0,   1,  23, 115,   0,  10,
       102,   0,   8,   2,  11,   4,   6,   1,   1,  27, 131,   0,   4,   6,
         2,  10, 121,   0,   1,  26, 138,   0,  10, 125,   0,   8,   3,  11,
         3,  46, 147,   0,   1,  11,   3,  47, 153,   0,   2,  11,   0,  40,
         4,   4,   3,   0,  41,  11,   4,   0,   1,   0,   0,  11
    };
    public NTData[] nts = {
      new NTData(   1, false, new Sets.Set256(0x0004)),
      new NTData(  22, false, new Sets.Set256(0x0080)),
      new NTData(  40, false, new Sets.Set256(0x0000, 0x000e, 0x4000)),
      new NTData(  54, false, new Sets.Set256(0x0000, 0x000e, 0x4000)),
      new NTData(  95, false, new Sets.Set256(0x0000, 0x0000, 0xc100)),
      new NTData( 118, false, new Sets.Set256(0x0000, 0x0000, 0xc100)),
      new NTData( 141, false, new Sets.Set256(0x0000, 0x0000, 0xc100))
    };
    public Sets.Set256[] epsSets = {
      new Sets.Set256(0x0000, 0x0000, 0x2000),
      new Sets.Set256(0x0000, 0x0008, 0x0200),
      new Sets.Set256(0x0000, 0x00c8, 0x0200)
    };
    public Sets.Set256[] anySets = {
      new Sets.Set256(0x0000)
    };
    public String[] names = {
      "end of file", "const", "void", "main", "return", "delete", "new",
      "int", "bool", "false", "true", "if", "else", "while", "break",
