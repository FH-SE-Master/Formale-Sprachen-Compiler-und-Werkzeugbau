  ...
  private class GrammarTable {
    ...
    public byte[] code = {
       ...
       187,   0,   6,  11,   5,  17, 193,   0,   7,  11,   5,  18, 199,   0,
        ...
        41,   4,   9,   2,   0,  42,   4,   8,   3,   1,  17,  99,   1,   4,
         8,   4,  17,  11,   8,   5,  11,  13,   0,  16,   0,  41,   4,   9,
         2,   0,  42,   4,   8,   3,  11,   0,   5,   0,  20,  11,   0,  12,
         0,  35,   2,  48,   1,   0,  20,  11,   0,  13,   0,  34,   5,   9,
       168,   1,   1,   1,  34, 165,   1,   5,   9, 152,   1,   3,  10, 140,
         1,   3,  49, 160,   1,   4,  10, 140,   1,   0,  14,  10, 140,   1,
         0,  20,  11,   3,  49, 176,   1,   2,  10, 140,   1,   0,  14,  10,
       140,   1,   0,  19,   0,  43,   0,  44,   2,  48,   1,   0,  20,  11,
         0,   3,   5,   9, 200,   1,   1,   0,  20,  11,   4,  21,   1,   1,
        30, 216,   1,   4,  21,   2,  10, 206,   1,   8,   6,  11,   4,  22,
         1,   1,  31, 232,   1,   4,  22,   2,  10, 222,   1,   8,   7,  11,
         4,  23,   1,   1,  38, 246,   1,   4,  23,   2,  11,   1,  39, 253,
         1,  10, 242,   1,   1,  32,   4,   2,  10, 242,   1,   1,  36,  11,
         2,  10, 242,   1,   1,  33,  18,   2,  10, 242,   1,   1,  37,  25,
         2,  10, 242,   1,   8,   8,  11,   1,  23,  55,   2,   4,  10,   1,
         1,  23,  45,   2,   4,  10,   2,  10,  35,   2,   1,  24,  52,   2,
        10,  39,   2,   8,   9,  11,   1,  24,  32,   2,  10,  32,   2,   1,
        40,  66,   2,   4,  11,   1,  11,   4,   6,   1,   1,  28,  77,   2,
         2,  48,   2,   5,   3,  86,   2,   3,  11,   4,   4,   4,   1,  20,
        94,   2,  11,   4,   7,   5,  11,   1,  28, 102,   2,   2,  48,   1,
         1,  43, 111,   2,   0,  44,   1,  21, 134,   2,   4,   6,   2,   1,
        28, 122,   2,   2,  48,   3,   1,  43, 111,   2,   0,  44,  10, 111,
         2,   8,   2,  11,   1,   9, 142,   2,  11,   0,   6,  11,   2,  48,
         1,   1,  25, 155,   2,   0,  20,  11,   1,  26, 162,   2,  10, 152,
         2,   1,  43, 179,   2,   4,   9,   2,   0,  44,   0,  22,   4,   9,
         3,  10, 152,   2,   9,  10, 186,   2,  10, 171,   2,   0,  41,   5,
        12, 193,   2,   4,   0,  42,  10, 152,   2,   4,   0,   1,   0,   0,
        11
    };
    public NTData[] nts = {
      ...
      new NTData( 358, false, new Sets.Set256(0x0000, 0x0001)),
      new NTData( 372, false, new Sets.Set256(0x0020)),
      new NTData( 377, false, new Sets.Set256(0x1000)),
      new NTData( 387, false, new Sets.Set256(0x2000)),
      new NTData( 437, false, new Sets.Set256(0x0000, 0x0008)),
      new NTData( 449, false, new Sets.Set256(0x0008)),
      new NTData( 459, false, new Sets.Set256(0x0184, 0x0180, 0x8300, 0x0001)),
      new NTData( 475, false, new Sets.Set256(0x0184, 0x0180, 0x8300, 0x0001)),
      new NTData( 491, false, new Sets.Set256(0x0184, 0x0180, 0x8300, 0x0001)),
      new NTData( 540, false, new Sets.Set256(0x0184, 0x0180, 0x8300, 0x0001)),
      new NTData( 574, false, new Sets.Set256(0x0184, 0x0000, 0x8300, 0x0001)),
      new NTData( 582, false, new Sets.Set256(0x0242)),
      new NTData( 610, false, new Sets.Set256(0x0000, 0x1000, 0x0000, 0x0001)),
      new NTData( 649, false, new Sets.Set256(0x0240)),
      new NTData( 657, false, new Sets.Set256(0x0000, 0x0000, 0x0000, 0x0001))
    };
